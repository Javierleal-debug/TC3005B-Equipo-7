    ...
    <>
      ...
      <Grid className="page-content">
        <Column sm={4} md={8} lg={8} className="table-block">
          <Form>
            <Stack>
              <Dropdown id="Type" onChange={handleTypeChange} label="Select Device Type" titleText="Type" items={items} />
              ...
              <TextInput id="EmployeeName" onChange={handleEmployeeNameChange} placeholder="Requisitor's Name" labelText="Employee Name" />
            </Stack>
          </Form>
        </Column>
        <Column sm={4} md={8} lg={8}>
          <Form>
            <Stack>
              <TextInput id="EmployeeEmail" onChange={handleEmployeeEmailChange} placeholder="Requisitor's Email" labelText="Employee Email" />
              <TextInput id="EmployeeSerial" onChange={handleEmployeeSerialChange} placeholder="Requisitor's Serial Number" labelText="Employee Serial" />
              <TextArea id='Comment' onChange={handleCommentChange} placeholder="Optional Comment" labelText="Comment" rows={6}/>
