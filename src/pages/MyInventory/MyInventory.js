...
const MyInventory = () => {
  ...
  const getItemsRequest = () => {
    ...
    axios
      .get(
        'https://peripheralsloanbackend.mybluemix.net/peripheral/byMngrEmail',
        requestRowData
      )
      .then(({ data }) => {
        console.log(data)
    ...
    <>
      ...
      <DataTable
        ...
        render={({
          ...
          <TableContainer title="My Device Inventory" {...getTableContainerProps()}>
            <TableToolbar {...getToolbarProps()}>
              ...
              <TableToolbarContent>
                ...
                <Button 
                  onClick={()=>{
                    window.location.hash = '/my-inventory/new-device'
                  }}
